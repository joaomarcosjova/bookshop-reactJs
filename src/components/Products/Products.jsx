    ...
    <main className={classes.mainPage}>
      ...
      <div className={classes.hero}>
        ...
        <div className={classes.heroCont}>
          ...
          Descubra centenas de pesquisas
          </h1>
          <h3 className={classes.heroDesc} ref={sectionRef}>
          Explore teses, dissertações, trabalhos de conclusão de curso e livros acadêmicos.
          </h3>
      ...
      {searchTerm === "" && (
        <>
          <div>
            ...
            Mais <span style={{ color: "#f1361d" }}>baixados</span>
            </h3>
            <Grid
